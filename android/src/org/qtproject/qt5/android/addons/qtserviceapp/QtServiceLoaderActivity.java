...
import org.qtproject.qt5.android.addons.R;
...
public class QtServiceLoaderActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        i = new Intent(this, QtService.class);
    ...
    private boolean isMyServiceRunning() {
        ...
        for (RunningServiceInfo service : manager.getRunningServices(Integer.MAX_VALUE)) {
            if (QtService.class.getName().equals(service.service.getClassName())) {
                return true;
            }
        }
        return false;
